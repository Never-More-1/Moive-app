...
public class FilmUpdateDto {
    ...
    public FilmUpdateDto() {}

    public FilmUpdateDto(String title, Integer releaseYear, String director) {
        this.title = title;
        this.releaseYear = releaseYear;
        this.director = director;
    }

    public FilmUpdateDto(String title, Integer releaseYear, String director, Integer adminUserId) {
        this.title = title;
        this.releaseYear = releaseYear;
        this.director = director;
